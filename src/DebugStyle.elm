...
debug devices =
    [ Css.Global.each
        ...
        , Css.property "background-image" (box "rgba(0, 0, 255, .2)")
        ]
    , Css.Global.each
        [ Css.Global.table
        , Css.Global.td
    ...
    , Css.Global.each
        ...
        [ Css.property "background-image" (box "rgba(255, 0, 0, .2)")
        ]
    , Css.Global.each
        [ Css.Global.li
        ]
        [ Css.property "background-image" (box "rgba(0, 255, 0, .2)")
        ]
    , Css.Global.each
        [ Css.Global.li
        , Css.Global.div
    ...
    , Css.Global.each
        ...
        [ Css.property "background-image" (lines "hsla(200, 100%, 50%, .05)")
